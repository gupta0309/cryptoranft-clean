                        ...
                        <div className="card shadow border-0" style={{ backgroundColor: "var(--background-color-gray)" }}>
                            <div className="card-body text-center" style={{ border: "2px solid #323232", borderTop: "2px solid red", borderRadius: "7px" }}>
                                ...
                                <div className="d-flex   mt-2 justify-content-center ">
                                    ...
                                    <h5 className="text-white mr-1  text-success ">10000  </h5>
                                    <small>CSTAR</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="card shadow border-0" style={{ backgroundColor: "var(--background-color-gray)" }}>
                            <div className="card-body text-center" style={{ border: "2px solid #323232", borderTop: "2px solid red", borderRadius: "7px" }}>
                                ...
                                <div className="d-flex   mt-2 justify-content-center ">
                                    ...
                                    <h5 className="text-white mr-1 text-success   ">300  </h5>
                                    <small>CSTAR</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="card shadow border-0" style={{ backgroundColor: "var(--background-color-gray)" }}>
                            <div className="card-body text-center" style={{ border: "2px solid #323232", borderTop: "2px solid red", borderRadius: "7px" }} >
                                ...
                                <div className="d-flex   mt-2 justify-content-center ">
                                    ...
                                    <h5 className="text-white mr-1 text-success  ">400  </h5>
                                    <small>CSTAR</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="card shadow border-0" style={{ backgroundColor: "var(--background-color-gray)" }}>
                            <div className="card-body text-center" style={{ border: "2px solid #323232", borderTop: "2px solid red", borderRadius: "7px" }}>
                                ...
                                <div className="d-flex   mt-2 justify-content-center ">
                                    ...
                                    <h5 className="text-white mr-1 text-success  ">50  </h5>
                                    <small>CSTAR</small>
                                </div>
                            </div>
                        </div>
...
export default RevenueHeadUser